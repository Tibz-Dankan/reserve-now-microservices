...
func getAllRoomAmenities(w http.ResponseWriter, r *http.Request) {
	room := models.Room{}
...
func getAllRoomAmenitiesRoute(router *mux.Router) {
	router.HandleFunc("/api/v1/room/get-all-room-amenities", getAllRoomAmenities).Methods("GET")
}
